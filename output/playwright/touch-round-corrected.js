async(page)=>{
 ...
 await page.screenshot({path:'output/playwright/touch-round-corrected-before.png'});
 ...
 await page.screenshot({path:'output/playwright/touch-round-corrected-moving.png'});
