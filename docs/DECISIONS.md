...
2026-09-10 DEFAULT D85: GitHub Actions publishes a solo static project site under the repository name on main pushes or manual dispatch. BASE_PATH controls generated HTML entrypoint/import-map/home paths; model and audio URLs resolve relative to their modules. Default root build and Cloudflare configuration remain supported. No room enablement or deployment performed. See docs/DEPLOYMENT.md and M3-pages evidence.

2026-09-10 DEFAULT D86: User reports players enjoy Knockbound but 1v1 pushes lack impact and suggests stronger pushes and/or accumulated vulnerability. Playtest candidate: base dash/shovel push 7 to 8.5, vulnerability gain .2 to .3, recovery delay 2 to 6 seconds, recovery rate .1 to .05 per second. Cap remains2 and impulse cap22; movement/dash timing unchanged. Received qualifying hits increase susceptibility, not reduce outgoing attack strength. Item hits share vulnerability gain/recovery; wind's existing falloff floor follows dash baseline8.5. Same shared rules for humans/bots/local/online; compatibility bumped to0.12.7. Controlled four-second exchange fixture shows old buildup fully recovers; current fourth displacement4.319 versus old2.023. New feel remains pending user playtest. M3-duel-knockback records evidence.

2026-09-10 DEFAULT D87: Explicit user request authorizes team and boss implementation, including arbitrary supported equal splits of12. Mode registry arena/teams/boss; teams2–6 members with at least2teams, round-robin seat assignment, friendly attack immunity and last-team outcome. Boss proof follows cloud concept via three latched runes then shared dash-pushed core; two phases and data-authored Cloud King/Tempest profiles scale core counts with roster size. Stable boss floor excludes tiles/remover only; other falling content remains. Pure shared authority, validated snapshots, input-only bots, winnerTeamId and defeat outcome; compatibility0.13.0. See PARTY_MODE_CONTRACT.md. Same-device multiplayer and other M4 work remain open. No deployment/spend.
